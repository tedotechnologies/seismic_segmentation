...
from prepare_data import SeismicDataset, TorchSeismicDataset
...
train_config = {
    ...
    "data": {
        ...
        "shape": (224, 224),
        "mask_dtype": 0  # Adjust if needed (e.g. np.uint8).
    },
    "clearml": {
...
# Load the SAM model and its processor.
...
for epoch in range(num_epochs):
    ...
    for batch_idx, batch in enumerate(pbar):
        ...
        # Ensure the prediction size matches the ground truth.
